...
export class SwapHandler {
  ...
  private _handle(token: Address, amountIn: BigInt): void {
    ...
    this._accPlatform(maxRewardAmount, token, true)
  ...
  private _accPlatform(amount: BigInt, token: Address, deposit: bool): void {
  ...
  private _distributeRewards(totalAmount: BigInt, token: Address): void {
    ...
    this._accPlatform(rewardAmount, token, false)
